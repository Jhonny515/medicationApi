...
public class PedidoControllerTest {
    ...
    public void addItem_expectInvokeServiceWithNoExceptions() {
        when(pedidoService.addItemToCart(any(Long.class),any(Long.class))).thenReturn(1L);

        System.out.println("Initiating 'PedidoControler.addItem()' method.......");
        controller.addItem(1L, 1L, UriComponentsBuilder.newInstance());
        System.out.println("'PedidoControler.addItem()' method was initiated.");

        verify(pedidoService).addItemToCart(any(Long.class),any(Long.class));
        System.out.println("Service Layer was invoked.");
        verifyNoMoreInteractions(pedidoService);
        System.out.println("Service Layer was only invoked once.");
    }
    ...
    public void alterItem_expectInvokeServiceWithNoExceptions() {
        when(pedidoService.alterItemQtd(any(Long.class),any(Long.class), any(Integer.class))).thenReturn(1L);

        System.out.println("Initiating 'PedidoControler.alterItem()' method.......");
        controller.alterItem(1L, 1L, 2, UriComponentsBuilder.newInstance());
    ...
    public void deleteItem_expectInvokeServiceWithNoExceptions() {
        when(pedidoService.deleteItemFromCart(any(Long.class),any(Long.class))).thenReturn(1L);

        System.out.println("Initiating 'PedidoControler.deleteItem()' method.......");
        controller.deleteItem(1L, 1L, UriComponentsBuilder.newInstance());
    ...
    @Test
    public void checkout_expectInvokeServiceWithNoExceptions() {
        when(pedidoService.checkoutPedido(any(Long.class))).thenReturn(new PedidoDTO());

        System.out.println("Initiating 'PedidoControler.checkout()' method.......");
